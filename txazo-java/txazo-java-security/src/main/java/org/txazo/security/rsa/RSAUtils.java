...
//
//import org.txazo.security.base64.Base64Test;
...
//        PKCS8EncodedKeySpec pkcs8EncodedKeySpec = new PKCS8EncodedKeySpec(Base64Test.decode(privateKey));
...
//        return Base64Test.encode(signature.sign());
//    }
//
//    public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
//        X509EncodedKeySpec x509EncodedKeySpec = new X509EncodedKeySpec(Base64Test.decode(publicKey));
//        KeyFactory keyFactory = KeyFactory.getInstance(Algorithm.RSA);
//        PublicKey key = keyFactory.generatePublic(x509EncodedKeySpec);
//        Signature signature = Signature.getInstance(Algorithm.MD5_WITH_RSA);
//        signature.initVerify(key);
//        signature.update(data);
//        return signature.verify(Base64Test.decode(sign));
//    }
//
